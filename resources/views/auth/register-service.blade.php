...
<head>
    ...
    <title>Inscription service - HealthPass</title>
...
<body class="min-h-screen bg-surface-container-low px-4 py-8 font-corps text-on-surface sm:px-8">
    <main class="mx-auto w-full max-w-3xl rounded-3xl bg-surface-container-lowest p-6 shadow-xl sm:p-10">
        <header class="mb-8 flex items-start justify-between gap-4 border-b border-outline-variant pb-6">
            <div><p class="mb-2 text-sm font-semibold uppercase tracking-[0.16em] text-primary">HealthPass</p><h1 class="font-titre text-3xl font-bold">Inscription service</h1><p class="mt-2 text-on-surface-variant">Créez le compte de votre service et rattachez-le à votre établissement.</p></div>
