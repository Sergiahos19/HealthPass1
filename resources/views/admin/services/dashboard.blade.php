...
<body class="bg-fond-page text-on-surface font-corps-standard h-screen flex overflow-hidden">
    ...
    <nav class="hidden md:flex fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-surface-container-lowest border-r border-bordure-douce flex-col p-4 z-40">
        ...
        <ul class="flex flex-col gap-2 grow">
            <li>
                <a @class(['flex items-center gap-3 px-3 py-2 rounded-lg font-label-fort text-label-fort transition-colors', 'bg-secondary-container text-on-secondary-container' => ! $section, 'text-on-surface-variant hover:bg-surface-container-high' => $section]) href="{{ route('service.dashboard') }}" @if (! $section) aria-current="page" @endif>
                    <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">dashboard</span>
                        Tableau de bord
                </a>
            </li>
            <li>
                <a @class(['flex items-center gap-3 px-3 py-2 rounded-lg font-label-fort text-label-fort transition-colors', 'bg-secondary-container text-on-secondary-container' => $section === 'analyses', 'text-on-surface-variant hover:bg-surface-container-high' => $section !== 'analyses']) href="{{ route('service.analyses') }}" @if ($section === 'analyses') aria-current="page" @endif>
                    <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 0;">science</span>
                    Analyses
                </a>
            </li>
            <li>
                <a @class(['flex items-center gap-3 px-3 py-2 rounded-lg font-label-fort text-label-fort transition-colors', 'bg-secondary-container text-on-secondary-container' => $section === 'parametres', 'text-on-surface-variant hover:bg-surface-container-high' => $section !== 'parametres']) href="{{ route('service.settings') }}" @if ($section === 'parametres') aria-current="page" @endif>
